...
(function(){
  ...
  ldCaret = {
    ...
    insert: function(n){
      ...
      if (typeof n === 'string') {
        ...
        if (obj.ns.setRangeText) {
          return obj.ns.setRangeText(txt);
        }
    ...
    _byPtr: function(arg$){
      var node, x, y, range, min, i$, to$, i, r, p, c, box, dist;
      node = arg$.node, x = arg$.x, y = arg$.y, range = arg$.range;
      if (!range) {
        range = document.createRange();
      }
    ...
    _byPtrInText: function(arg$){
      var node, x, y, range, i$, to$, i, box, dist, ref$, idx, min;
